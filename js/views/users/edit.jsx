	...
	render: function () {
		...
		return (
			<form ref="form" 
				...
				noValidate>
			<fieldset>
				<legend>Have some jokes? Become an author!</legend>
				...
				<button type="submit" onClick={this.createUser}>I'm ready to tell some jokes!</button>
			</fieldset>
			</form>
		); 
	} 
